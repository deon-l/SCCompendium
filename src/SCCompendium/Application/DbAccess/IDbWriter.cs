...
public interface IDbWriter
{
    ...
    /// </summary>
    public void InitiateDatabase(IDbConnection connection, IDbSettingsManager settings);

    /// <summary>
    /// Write the entirety of <paramref name="rules"/> into the database.
    /// </summary>
    public void Write(IDbConnection connection, IDbSettingsManager settings, List<PhonologicalRuleGroup> rules);
}
