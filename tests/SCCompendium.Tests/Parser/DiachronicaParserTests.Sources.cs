...
{
    /// <remarks>
    /// The content of this string is the raw source of the Index Diachronica v10.2 in its entirety,
    /// accessed at https://chridd.nfshost.com/diachronica/index-diachronica.tex?as=text.
    /// It was compiled by Pogostick Man, and is licensed under the
    /// Creative Commons Attribution-NonCommercial-ShareAlike (CC BY-NC-SA) 3.0 license
    /// Visit http://creativecommons.org/licenses/by-nc-sa/3.0/ for further details.
    ///
    /// Thus, the content of the string is not covered under from the repository level license.
    /// </remarks>
    private const string _sampleDiachronica =
"""
